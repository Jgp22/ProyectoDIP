	...
	<div class="col-lg-10 container">
		...
		<div id="mision" class="row">
	        <div class="text-justify">
	            <h4 class="media-heading"><b>Misión</b></h4>
	            <p>
	    ...
	    <div id="vision" class="row">
	        <div class="text-justify">
	            <h4 class="media-heading"><b>Visión</b></h4>
	            <p>
	    ...
	    <hr>
	    <div id="estructuraOrganizativa" class="row">
	        <div class="text-justify">
	            <h4 class="media-heading"><b>Estructura Organizativa</b></h4>
	            <p>
	          		<img src="img/DIP-EO.jpg" alt="" class="img-responsive">
	            </p>
	        </div>
	    </div>
	</div>
